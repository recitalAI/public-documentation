...
<figure><img src="../.gitbook/assets/production_review_queue.png" alt="Liste des Agents d'extraction avec le nombre de documents à corriger"><figcaption>Onglet <em>Extraction</em> de Review. Chaque ligne correspond à un Agent et au nombre de documents en attente.</figcaption></figure>
