...
| Profondeur maximale de décompression | `1` extrait seulement le premier niveau ; les archives ou e-mails imbriqués restent des fichiers. Une valeur non renseignée n'impose pas de limite. |
